...
export const updateUser = createAsyncThunk('user/updateUser', async (data: any, { rejectWithValue }) => {
...
export const register = createAsyncThunk('user/register', async (data: any, { rejectWithValue }) => {
...
export const sendMailResetPassword = createAsyncThunk('user/sendMailResetPassword', async (data: any, { rejectWithValue }) => {
...
export const verifyResetPassword = createAsyncThunk('user/verifyResetPassword', async (data: any, { rejectWithValue }) => {
...
export const resetPassword = createAsyncThunk('user/resetPassword', async (data: any, { rejectWithValue }) => {
