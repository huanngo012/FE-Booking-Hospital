...
export const getPatients = createAsyncThunk('patient/getPatients', async (data: any, { rejectWithValue }) => {
...
export const addPatient = createAsyncThunk('patient/addPatient', async (data: any, { rejectWithValue }) => {
...
export const patientSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(updatePatient.fulfilled, (state, action) => {
      state.loadingPatient = false
      state.patients = state.patients.map((el: any) => (el?._id === action.payload?._id ? action.payload : el))
