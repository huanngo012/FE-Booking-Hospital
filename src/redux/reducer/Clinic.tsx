...
export const getClinics = createAsyncThunk('clinic/clinicsFetch', async (data: any, { rejectWithValue }) => {
...
export const getClinicsTop = createAsyncThunk('clinic/getClinicsTop', async (data: any, { rejectWithValue }) => {
  const response: any = await apis.apiGetAllClinics(data)
  if (!response.success) {
    return rejectWithValue(response)
  }
...
export const ratingClinic = createAsyncThunk('clinic/ratingClinic', async (data: any, { rejectWithValue }) => {
