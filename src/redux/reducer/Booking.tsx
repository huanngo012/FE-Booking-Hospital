...
export const getBookings = createAsyncThunk('booking/getBookings', async (data: any, { rejectWithValue }) => {
...
export const addBooking = createAsyncThunk('booking/addBooking', async (data: any, { rejectWithValue }) => {
...
export const cancelBooking = createAsyncThunk(
  ...
  async ({ id, data }: { id: string; data: any }, { rejectWithValue }) => {
    const response: any = await apis.apiCancelBooking(id, data)
    if (!response.success) {
      return rejectWithValue(response.message)
    }
    return response.message
