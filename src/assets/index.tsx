...
import  SrollUpIcon  from "./svg/scroll-up.svg?react";
...
import  CancelIcon  from "~/assets/svg/cancel-icon.svg?react";
import  ErrorRoundedIcon  from "./svg/error-rounded-icon.svg?react";
