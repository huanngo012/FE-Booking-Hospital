...
const CustomDataGrid = (props: CustomDataGridProps) => {
  const { pageSize = 5, totalRow = 99, rows = [], columns = [], page = 1, setPage, slots, headerComponent, showPagination = true } = props
    ...
    <Stack direction='column' className='table__wrapper'>
      ...
      <Box className='table-body'>
        <Box className='data-grid__container'>
          ...
          {/* Pagination */}
          {showPagination && (
            <Stack direction='row' className='pagination' justifyContent='flex-end' alignItems='center'>
