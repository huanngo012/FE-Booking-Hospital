  ...
  return (
    ...
    >
      <Stack flexDirection='row' gap='16px' alignItems='center'>
        <FaUserCircle />
        <Box>
          <Typography variant='label2' color='var(--primary)' sx={{ textTransform: 'uppercase' }}>
            {data.fullName}
          </Typography>
        </Box>
      </Stack>
      <Stack flexDirection='row' gap='16px' alignItems='center'>
        ...
        <Typography variant='body2'>{moment(data.dob).format('DD/MM/yyyy')}</Typography>
      </Stack>
      <Stack flexDirection='row' gap='16px' alignItems='center'>
        <Stack flexDirection='row' gap='16px' alignItems='center'>
          <FaPhoneAlt />
      ...
      <Stack flexDirection='row' gap='16px' alignItems='center'>
        ...
        <Typography variant='body2'>{data.gender === 'MALE' ? 'Nam' : 'Nữ'}</Typography>
      </Stack>
      <Stack flexDirection='row' gap='16px' alignItems='center'>
